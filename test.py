...
import matplotlib.pyplot as plt  # Changed 'matplotlib as plt' to 'import matplotlib.pyplot as plt'
...
image = cv2.cvtColor(cv2.imread("bright.jpg"), cv2.COLOR_BGR2RGB)
...
# model = tf.keras.models.load_model('C:/Users/SAI VISHWA/Downloads/word_segmentation-master/word_segmentation-master/model3.h5')
act_model,outputs,inputs=Model1()


def predict():
 for j in range(i):
   your_image_path = "C:/Users/SAI VISHWA/Downloads/word_segmentation-master/word_segmentation-master/segmented/segment"+ str(j) + ".png"
